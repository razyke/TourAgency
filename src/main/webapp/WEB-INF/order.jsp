    ...
    <header id="header">
        ...
        <nav id="nav">
            <ul>
                ...
                <% } else {%>
                <li><a href="register" class="button special"><% out.print(bundle.getString("global.register"));%></a>
                </li>
                ...
                <div class="row 50%">
                    <div class="6u 12u(mobile)">
                        <input type="radio" name="days"
                               value="seven"> <% out.print(bundle.getString("global.price7"));%>
                        : ${tour.costSevenDays} </input>
                        <input type="hidden" name="cost7" value="${tour.costSevenDays}"> </input>
                    </div>
                    <div class="6u 12u(mobile)">
                        <input type="radio" name="days" value="ten"
                               checked> <% out.print(bundle.getString("global.price10"));%>
                        : ${tour.costTenDays} </input>
                    ...
                    <div class="12u">
                        <ul class="buttons">
                            ...
                            <li><input type="submit" class="special"
                                       value="<% out.print(bundle.getString("global.order"));%>"/></li>
                            <% } else { %>
                            <li><a href="login" class="button special"><%
                                out.print(bundle.getString("global.sign_in"));%></a></li>
                            <% } %>
                        </ul>
                    </div>
                </div>
