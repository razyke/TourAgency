...
<article id="main">
 ...
 <div class="row">
                    <div class="12u">
                        <ul class="buttons">
                                <li><input type="submit" class="special" name="manage" value="<%out.print(bundle.getString("global.approve"));%>" /></li>
                               <li><input type="submit" class="special" name="manage" value="<%out.print(bundle.getString("global.disapprove"));%>" /></li>
                        </ul>
                    </div>
                </div>
            </form>
