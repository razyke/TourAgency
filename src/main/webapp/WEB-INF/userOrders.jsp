            ...
            <div class="more_listing">
                <c:choose>
                    <c:when test="${orders.currentPage != 1}">
                        <a href="/userOrders?page=1" class="more_listing_btn_small">
                            <%out.print(bundle.getString("global.to_first_page"));%></a>
                    </c:when>
                </c:choose>
                <c:choose>
                    <c:when test="${orders.currentPage != 1}">
                        <a href="/userOrders?page=<c:out value="${orders.currentPage-1}"/>" class="more_listing_btn_small">
                ...
                <c:choose>
                    <c:when test="${orders.currentPage != orders.totalPages}">
                        <a href="/userOrders?page=<c:out value="${orders.totalPages}"/>" class="more_listing_btn_small">
